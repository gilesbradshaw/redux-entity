...
var _extends39 = require('babel-runtime/helpers/extends');

var _extends40 = _interopRequireDefault(_extends39);
...
var getModule = function getModule(_ref) {
  ...
  var joinSingle = function joinSingle(id, type) {
      ...
      return Rx.Observable.of(1).switchMap(function (x) {
        return signalR().switchMap(function (subscriber) {
          return Rx.Observable.of(1).flatMap(function (x) {
            return subscriber.join(getJoinSingleId(id, type)).flatMap(function (messages) {
              return Rx.Observable.of(messages.filter(function (message) {
  ...
  var load = function load() {
    ...
    return function (_ref4) {
      ...
      var _loadConfig = (0, _extends40.default)({}, loadConfig, {
    ...
    return function (_ref8) {
      ...
      return function (actions, _ref9) {
        ...
        if (getLoadSingleHasChanged({ id: id, getState: getState })) {
          return joinSingle(id, type)({ signalR: signalR, apiClient: apiClient }).flatMap(function (changes) {
          ...
          .takeUntil(Rx.Observable.empty().delay(0).concat(actions.ofType(ENTITY_LOAD).filter(function (action) {
            return action.payload.id === id && action.payload.type === type;
          })
  ...
  var singleLoadErrorCancel = function singleLoadErrorCancel(id) {
    var type = arguments.length <= 1 || arguments[1] === undefined ? 'default' : arguments[1];
    return {
        ...
        var _ret4 = function () {
          ...
          return {
            v: function v(actions, _ref18) {
              ...
              return apiClient.post(postPath, {
                data: postConvert((0, _extends40.default)({}, values, { Id: 0 }))
              }, files).flatMap(function (result) {
                return Rx.Observable.of(result.result ? {
                  type: ENTITIES_UPLOAD_SUCCESS,
                  payload: {
    ...
    return function (_ref19) {
      ...
      return function (actions, _ref20) {
        ...
        return apiClient.del(deletePath).flatMap(function (result) {
          return Rx.Observable.of(result.result ? {
            type: ENTITIES_DELETE_SUCCESS, id: id
          } : {
            type: ENTITIES_SAVE_PROGRESS,
            payload: {
              id: id,
    ...
    if (state.loadOrder) {
      var _ret5 = function () {
        ...
        var ret = values.map(function (value) {
          ...
          return value.IsDeleted && deleted || !value.IsDeleted && !deleted;
        }).sort(function (a, b) {
  ...
  var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_LOAD, function (state, action) {
    return (0, _extends40.default)({}, state, {
      data: null,
      loadInitial: null,
      error: null,
      loading: true,
    ...
    return (0, _extends40.default)({}, state, {
      data: (0, _extends40.default)({}, state.data, { Values: state.data.Values.concat(action.payload.Values) }),
      loadingMore: false,
    ...
    return (0, _extends40.default)({}, state, {
      single: (0, _extends40.default)({}, state.single, (0, _defineProperty3.default)({}, action.payload.id, (0, _extends40.default)({}, state.single && state.single[action.payload.id], (0, _defineProperty3.default)({}, action.payload.type, {
        loading: true,
    ...
    return (0, _extends40.default)({}, state, {
      single: (0, _extends40.default)({}, state.single, (0, _defineProperty3.default)({}, action.payload.id, (0, _extends40.default)({}, state.single && state.single[action.payload.id], (0, _defineProperty3.default)({}, action.payload.type, null))))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_EDIT_START, function (state, action) {
    return (0, _extends40.default)({}, state, {
      editing: (0, _extends40.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, true))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_EDIT_STOP, function (state, action) {
    return (0, _extends40.default)({}, state, {
      data: (0, _extends40.default)({}, state.data, {
        Values: state.data && state.data.Values ? state.data.Values.filter(function (value) {
          return !value.isNew || value.Id != action.id;
        }) : []
      }),
      editing: (0, _extends40.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, false))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE, function (state, action) {
    return (0, _extends40.default)({}, state, {
      saveError: (0, _extends40.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.values.Id, null)),
      saving: (0, _extends40.default)({}, state.saving, (0, _defineProperty3.default)({}, action.values.Id, action.values))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_PROGRESS, function (state, action) {
    return (0, _extends40.default)({}, state, {
      saveProgress: (0, _extends40.default)({}, state.saveProgress, (0, _defineProperty3.default)({}, action.payload.id, action.payload.progress))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_SUCCESS, function (state, action) {
    return (0, _extends40.default)({}, state, {
      editing: (0, _extends40.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, action.keepEditing ? state.editing[action.id] : false)),
      saveProgress: (0, _extends40.default)({}, state.saveProgress, (0, _defineProperty3.default)({}, action.id, null)),
      saving: (0, _extends40.default)({}, state.saving, (0, _defineProperty3.default)({}, action.id, false))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_FAIL, function (state, action) {
    return (0, _extends40.default)({}, state, {
      saving: (0, _extends40.default)({}, state.saving, (0, _defineProperty3.default)({}, action.id, false)),
      saveProgress: (0, _extends40.default)({}, state.saveProgress, (0, _defineProperty3.default)({}, action.id, null)),
      saveError: (0, _extends40.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.id, action.error))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_FAIL_CANCEL, function (state, action) {
    return (0, _extends40.default)({}, state, {
      saveError: (0, _extends40.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.id, null))
    });
    ...
    if (state.data && state.data.Values) {
      ...
      var replace = (0, _extends40.default)({}, found, action.payload);
    ...
    if (found) {
      var replace = (0, _extends40.default)({}, action.payload);
      state.data.Values.splice(state.data.Values.indexOf(found), 1, replace);
    } else {
    ...
    return (0, _extends40.default)({}, state, {
      single: (0, _extends40.default)({}, state.single, (0, _defineProperty3.default)({}, action.payload.id, (0, _extends40.default)({}, state.single && state.single[action.payload.id], (0, _defineProperty3.default)({}, action.payload.type, (0, _extends40.default)({}, state.single && state.single[action.payload.id] && state.single[action.payload.id][action.payload.type], {
        data: (0, _extends40.default)({}, state.single && state.single[action.payload.id] && state.single[action.payload.id][action.payload.type] && state.single[action.payload.id][action.payload.type].data, action.payload.value)
      })))))
    });
    ...
    return (0, _extends40.default)({}, state, {
      deleting: (0, _extends40.default)({}, state.deleting, (0, _defineProperty3.default)({}, action.id, false)),
    ...
    return (0, _extends40.default)({}, state, {
      deleting: (0, _extends40.default)({}, state.deleting, (0, _defineProperty3.default)({}, action.id, true))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_UPLOAD, function (state, action) {
    return (0, _extends40.default)({}, state, {
      uploading: (0, _extends40.default)({}, state.uploading, (0, _defineProperty3.default)({}, action.payload.values.Id, (0, _extends40.default)({}, state.uploading && state.uploading[action.payload.values.Id], (0, _defineProperty3.default)({}, action.payload.uploadType, action.payload))))
    });
    ...
    return (0, _extends40.default)({}, state, nullIfNone(state, action.payload.values.Id, 'uploading', action.payload.uploadType));
    ...
    return (0, _extends40.default)({}, state, nullIfNone(state, action.payload.id, 'uploading', action.payload.uploadType));
  }), _ACTION_HANDLERS);

  var nullIfNone = function nullIfNone(state, id, fieldName, subFieldName) {
    return (0, _defineProperty3.default)({}, fieldName, (0, _extends40.default)({}, state[fieldName], (0, _defineProperty3.default)({}, id, null), state[fieldName] && state[fieldName][id] && ((0, _keys2.default)(state[fieldName][id]).length > 1 || !state[fieldName][id][subFieldName]) && (0, _defineProperty3.default)({}, id, (0, _extends40.default)({}, state[fieldName] && state[fieldName][id], (0, _defineProperty3.default)({}, subFieldName, null)))));
  };
