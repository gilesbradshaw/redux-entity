...
var getModule = function getModule(_ref) {
  ...
  var load = function load() {
    ...
    return function (_ref4) {
      ...
      var _loadConfig = (0, _extends14.default)({}, loadConfig, { isDeleted: loadConfig.isDeleted && loadConfig.isDeleted != 'false' });
      ...
      return function (actions, _ref5) {
        ...
        if (getLoadHasChanged({ loadDefaults: loadDefaults, getState: getState })) {
          ...
          }).startWith({ type: ENTITIES_LOAD, payload: loadDefaults }).takeUntil(Rx.Observable.empty().delay(0).concat(actions.ofType(ENTITIES_LOAD)));
        } else {
  ...
  var loadMore = function loadMore(loadConfig) {
    return function (_ref6) {
      ...
      return function (actions, _ref7) {
        ...
        return Rx.Observable.fromPromise(apiClient.get(getLoadPath(getLoadDefaults(loadConfig)))).map(function (result) {
  ...
  var loadSingle = function loadSingle(id, then) {
      ...
      return function (actions, _ref9) {
        ...
        if (getLoadSingleHasChanged({ id: id, getState: getState })) {
          return joinSingle(id)({ signalR: signalR, apiClient: apiClient }).flatMap(function (changes) {
            return Rx.Observable.fromPromise(apiClient.get(getSinglePath(id))).do(function (result) {
  ...
  var save = function save(values, keepEditing) {
          ...
          return {
            v: function v(actions, _ref11) {
              ...
              apiClient.put(putPath, {
                ...
                return Rx.Observable.of({ type: ENTITIES_SAVE_SUCCESS, id: values.Id, keepEditing: keepEditing });
              }).catch(function (error) {
  ...
  var ACTION_HANDLERS = (_ACTION_HANDLERS = {}, (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_LOAD, function (state, action) {
    ...
    return (0, _extends14.default)({}, state, {
      data: (0, _extends14.default)({}, state.data, { Values: state.data.Values.concat(action.payload.Values) }),
      loadingMore: false
    });
    ...
    return (0, _extends14.default)({}, state, {
      editing: (0, _extends14.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, true))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_EDIT_STOP, function (state, action) {
    return (0, _extends14.default)({}, state, {
      data: (0, _extends14.default)({}, state.data, {
        Values: state.data && state.data.Values ? state.data.Values.filter(function (value) {
          return !value.isNew || value.Id != action.id;
        }) : []
      }),
      editing: (0, _extends14.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, false))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE, function (state, action) {
    return (0, _extends14.default)({}, state, {
      saveError: (0, _extends14.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.values.Id, null)),
      saving: (0, _extends14.default)({}, state.saving, (0, _defineProperty3.default)({}, action.values.Id, action.values))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_SUCCESS, function (state, action) {
    return (0, _extends14.default)({}, state, {
      editing: (0, _extends14.default)({}, state.editing, (0, _defineProperty3.default)({}, action.id, action.keepEditing ? state.editing[action.id] : false)),
      saving: (0, _extends14.default)({}, state.saving, (0, _defineProperty3.default)({}, action.id, false))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_FAIL, function (state, action) {
    return (0, _extends14.default)({}, state, {
      saving: (0, _extends14.default)({}, state.saving, (0, _defineProperty3.default)({}, action.id, false)),
      saveError: (0, _extends14.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.id, action.error))
    });
  }), (0, _defineProperty3.default)(_ACTION_HANDLERS, ENTITIES_SAVE_FAIL_CANCEL, function (state, action) {
    return (0, _extends14.default)({}, state, {
      saveError: (0, _extends14.default)({}, state.saveError, (0, _defineProperty3.default)({}, action.id, null))
    });
    ...
    if (state.data && state.data.Values) {
      ...
      var replace = (0, _extends14.default)({}, found, action.payload);
    ...
    if (found) {
      var replace = (0, _extends14.default)({}, action.payload);
      state.data.Values.splice(state.data.Values.indexOf(found), 1, replace);
    } else {
    ...
    if (state.singleData && state.singleData.Id == action.payload.Id) {
      return (0, _extends14.default)({}, state, {
        singleData: (0, _extends14.default)({}, state.singleData, action.payload)
      });
    }
    return state;
    ...
    return (0, _extends14.default)({}, state, {
      deleting: (0, _extends14.default)({}, state.deleting, (0, _defineProperty3.default)({}, action.id, false)),
      data: (0, _extends14.default)({}, state.data, {
        Values: state.data.Values.filter(function (state) {
          return state.Id !== action.id;
        })
    ...
    return (0, _extends14.default)({}, state, {
      editing: (0, _extends14.default)({}, state.editing, {
        add: true
      }),
      data: (0, _extends14.default)({}, state.data, {
        Values: [{
    ...
    return (0, _extends14.default)({}, state, {
      ...
      saving: (0, _extends14.default)({}, state.saving, {
        add: false
      }),
      editing: (0, _extends14.default)({}, state.editing, {
        add: false
    ...
    return (0, _extends14.default)({}, state, {
      deleting: (0, _extends14.default)({}, state.deleting, (0, _defineProperty3.default)({}, action.id, true))
    });
  }), _ACTION_HANDLERS);
